...
public class ProjectDetailAction implements Action {
    ...
    public ActionForward execute(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
	        ...
	        System.out.print(projectDetail1);//값 확인
	        
	        //진행과정 추가
	        ProjectDAO projectDAO3 = new ProjectDAO();
	        List<ProjectDetail> projectDetail2 = projectDAO3.getProjectDetail2(projectId); //db값 가져와 진행률 반영
	        req.setAttribute("project2", projectDetail2);
	        System.out.print(projectDetail2);//값 확인
