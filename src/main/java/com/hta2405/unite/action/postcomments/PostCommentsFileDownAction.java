...
public class PostCommentsFileDownAction implements Action {
    private static final String DOWNLOAD_DIRECTORY = ConfigUtil.getProperty("postComment.upload.directory");
    ...
    public ActionForward execute(HttpServletRequest req, HttpServletResponse resp)
        ...
        String sFilePath = DOWNLOAD_DIRECTORY + File.separator + postCommentData.getPostCommentFileUUID() + "_" + postCommentData.getPostCommentFileOriginal();
