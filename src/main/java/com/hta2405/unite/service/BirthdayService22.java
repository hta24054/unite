...
@Service
@Slf4j
public class BirthdayService22 {
    ...
    public BirthdayService22(@Value("${birthday.apiKey}") String apiKey, EmpMapper empMapper, RedisTemplate<String, String> redisTemplate) {
        this.apiKey = apiKey;
